  ...
  projects: [
    {
      ...
      date: "Spring 2023",
      descriptions: [
        "Created and launched a professional resume builder web app that helps thousands of users create ATS-optimized resumes and land their dream jobs with advanced analytics and scoring features",
      ],
    },
  ],
  skills: {
